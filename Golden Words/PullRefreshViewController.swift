...
// This class is just used as a template to implement the refresh control into all other view controllers
class PullRefreshViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func getNextColor() -> UIColor {
        var colorsArray: [UIColor] = [UIColor.magentaColor(), UIColor.brownColor(), UIColor.yellowColor(), UIColor.redColor(), UIColor.greenColor(), UIColor.blueColor(), UIColor.orangeColor(), UIColor.whiteColor()]
